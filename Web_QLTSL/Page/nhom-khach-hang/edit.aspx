<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="Web_QLTSL.Page.nhom_khach_hang.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <input id="txtTenNhomKhachhang" type="text" required class="form-control" placeholder="Tên nhóm khách hàng" runat="server">
