<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Web_QLTSL.Login" %>
                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="login-container">
                        <div class="center">
                            ...
                            <h4 class="blue" id="id-company-text">&copy; QLTSL</h4>
                        </div>
                                    ...
                                    <div class="widget-main">
                                        ...
                                        <form id="frm" runat="server">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="clearfix">
                                                    <asp:Button class="width-35 pull-right btn btn-sm btn-primary" onclick="btnLogin_Click" runat="server" Text="Login"/>
                                                </div>
