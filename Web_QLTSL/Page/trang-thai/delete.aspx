<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="delete.aspx.cs" Inherits="Web_QLTSL.Page.trang_thai.Delete" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="box-body">
        <div class="alert alert-danger alert-dismissible">
            ...
            Tất cả Người dùng có trạng thái này sẽ bị xóa bỏ.
            Bạn có muốn xóa ko?
            <div>
