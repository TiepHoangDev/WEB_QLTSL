<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="Web_QLTSL.Page.thiet_bi.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <input id="txtName" type="text" required class="form-control" placeholder="Tên Thiết bị" runat="server">
